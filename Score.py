...
winnings of the user. Amount of points for winning a games is as follows:
POINTS_OF_WINNING = (DIFFICULTY X 3) + 5
Each time the user is winning a games, the points he one will be added to his current amount of
